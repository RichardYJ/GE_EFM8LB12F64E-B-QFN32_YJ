...
#define  SLAVE_ADDR               0x10 // Device address for slave target       //0xF0
...
#define  NUM_BYTES_WR                2 /*4*/  	// Number of bytes to write		//I2C2_WRITE Ð´ 5 bytes
                                       			// Master -> Slave				//I2C2_READ	 Ð´3+¶Á3
